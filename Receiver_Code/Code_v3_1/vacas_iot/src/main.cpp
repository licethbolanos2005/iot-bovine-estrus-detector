...
void loop() {
  ...
  if (state == RADIOLIB_ERR_NONE) {
    ...
    // Guardar RSSI y SNR para el bridge
    Serial.print("[META] RSSI:"); Serial.print(rssi); Serial.println();
    Serial.print("[META] SNR:");  Serial.print(snr);  Serial.println();
    ...
    if (error) {
      ...
      Serial.print("[OK] RPM      : "); Serial.print(rpm); Serial.println(" resp/min");
